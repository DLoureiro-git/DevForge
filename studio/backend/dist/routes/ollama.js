...
router.post('/test', async (req, res) => {
    try {
        ...
        const response = await ollama.generate(model, 'Say "OK" if you can read this.', 'You are a test assistant. Respond with exactly "OK" and nothing else.', { temperature: 0, num_predict: 5 });

...
import { mkdirSync, writeFileSync, existsSync, readdirSync, statSync, createWriteStream } from 'fs'
...
export class ProjectGenerator {
   ...
   */
  createProjectStructure(config: ProjectStructureConfig): void {
   ...
   * Gerar package.json
   */
  generatePackageJson(prd: any, outputPath: string): void {
   ...
   * Gerar .env.example
   */
  generateEnvExample(architecture: any, outputPath: string): void {
   ...
   * Gerar README.md
   */
  generateReadme(config: ProjectStructureConfig): void {
...
`
   ...
   */
  generateDockerfile(outputPath: string): void {
...
`
   ...
   * Gerar .gitignore
   */
  generateGitignore(outputPath: string): void {
...
`
   ...
   */
  async zipProject(projectPath: string): Promise<Buffer> {
   ...
   */
  private formatDatabaseSchemaForReadme(schema: any): string {
 ...
 * Helper standalone
 */
export async function generateCompleteProject(config: ProjectStructureConfig): Promise<void> {

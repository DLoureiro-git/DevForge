...
import type { Bug } from './qa-engine';
...
describe('calculateQAScore', () => {
  ...
  test('score não fica negativo', () => {
    const bugs: Bug[] = Array(10).fill(null).map((_, i) => ({
      id: `bug-${i}`,
      checkId: 'test-001',
...
describe('estimateTotalTime', () => {
  test('calcula tempo total corretamente', () => {
    const checklist = [
      { id: '1', estimatedTime: 5 } as any,
      { id: '2', estimatedTime: 3 } as any,
      { id: '3', estimatedTime: 2 } as any,
    ];
...
describe('groupChecksByCategory', () => {
  test('agrupa checks por categoria', () => {
    const checklist = [
      { id: '1', category: 'deploy' } as any,
      { id: '2', category: 'deploy' } as any,
      { id: '3', category: 'auth' } as any,
    ];
...
describe('getAutomatableChecks', () => {
  test('filtra apenas checks automatizáveis', () => {
    const checklist = [
      { id: '1', automatable: true } as any,
      { id: '2', automatable: false } as any,
      { id: '3', automatable: true } as any,
    ];
